...
namespace Foam
{
    ...
    {
        defineTypeNameAndDebug(DarcyForchheimer2, 0);
        addToRunTimeSelectionTable(porosityModel, DarcyForchheimer2, mesh);
    }
}
...
Foam::porosityModels::DarcyForchheimer2::DarcyForchheimer2
(
    const word& name,
...
void Foam::porosityModels::DarcyForchheimer2::calcTransformModelData()
{
...
void Foam::porosityModels::DarcyForchheimer2::calcForce
(
...
void Foam::porosityModels::DarcyForchheimer2::correct
(
    fvVectorMatrix& UEqn
) const
{
...
bool Foam::porosityModels::DarcyForchheimer2::writeData(Ostream& os) const
{
